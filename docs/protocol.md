        # Robma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/robma.git

        ## Objective

        ROBMA (Robust Bayesian Meta-Analysis) implements robust Bayesian model averaging for meta-analysis, downweighting outlier studies and providing model-averaged posterior estimates.
        ...
        - Code: https://github.com/mahmood726-cyber/robma.git
        - Dashboard: N/A
